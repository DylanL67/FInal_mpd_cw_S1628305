...
public class ParseRoadIncidents {
    ...
    public ParseRoadIncidents(){

    }


        public List<RoadIncidents> getRSSFeedItems(String rss_url) {
            List<RoadIncidents> rssitemlist = new ArrayList<RoadIncidents>();
            String rss_feed_xml;
...
//                                Log.i("Added", roadIncidents.toString());
