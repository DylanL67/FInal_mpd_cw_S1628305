...
public class RoadIncidents implements Serializable {
    ...
    public RoadIncidents() {
        this.title = "UNDEFINED";
    }

    public RoadIncidents(String title, String description, String link, String georss, String pubDate){
        super();
        this.title = title;
