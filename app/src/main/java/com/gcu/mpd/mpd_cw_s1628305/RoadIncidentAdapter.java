...
public class RoadIncidentAdapter extends BaseAdapter implements Filterable {

    private List<RoadIncidents> dataSet;
    private List<RoadIncidents> filteredData;
    Context mContext;
    Date filterDate;
...
private static class ViewHolder {
    ...
    public RoadIncidentAdapter(List<RoadIncidents> data, Context context) {
    ...
    @Override
    public RoadIncidents getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        RoadIncidents dataModel = filteredData.get(position);
        ...
        convertView= mLayoutInflater.inflate(R.layout.road_incident_list_row, null);
    ...
    public Filter getFilter() {
        ...
        return new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                filteredData = (List<RoadIncidents>) results.values;
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                ArrayList<RoadIncidents> filteredArrayNames = new ArrayList<>();
